...
const CartClient: React.FC<CartClientProps> = ({ currentUser }) => {
  ...
  if (!cartProducts || cartProducts.length === 0) {
    return (
      <div className="flex flex-col items-center">
        <div className="text-2xl">Ваш кошик порожній</div>
        <div>
          <Link
            href={"/"}
            className="
  ...
  return (
    <div>
      ...
      "
      >
        <div className="col-span-2 justify-self-start">ПРОДУКТ</div>
        <div className="justify-self-center">ЦІНА</div>
        <div className="justify-self-center">КІЛЬКІСТЬ</div>
        <div className="justify-self-end">РАЗОМ</div>
      </div>
      <div>
        {cartProducts &&
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex justify-between gap-4">
        ...
        <div className="text-sm flex flex-col gap-1 items-start">
          ...
          <Button
            label={currentUser ? "Оплатити" : "Перехід до оплати"}
